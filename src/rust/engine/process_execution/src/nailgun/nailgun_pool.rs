...
use crate::{
    ExecuteProcessRequest, ExecuteProcessRequestMetadata, MultiPlatformExecuteProcessRequest,
};
...
impl NailgunPool {
    ...
    fn start_new_nailgun(
        ...
        NailgunProcessMetadata::start_new(
            name.clone(),
            startup_options,
            workdir_path,
            nailgun_req_digest,
...
impl NailgunProcessMetadata {
    fn start_new(
        ...
        workdir_path: &PathBuf,
        nailgun_req_digest: Digest,
    ) -> Result<NailgunProcessMetadata, String> {
